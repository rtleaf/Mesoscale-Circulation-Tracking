# This function takes Mean Dynamic Topography (MDT) data and adds it to Sea Surface Height Anomaly (SSHA) data to get 
# sea surface height (SSH). 
# The key point of this function is that it alters the MDT data extent and resolution to that of the SSHA 
# to then be added together. 
# The function also crops the data to the desired study area. 
# The input requires a geotifs for the MDT and SSHA data. Please be careful with the units of both data sets 
# as the current code accounts for MDT as #
# meters and SSHA as cm. CRS of both data are assumed to be the same.
